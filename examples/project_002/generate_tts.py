...
def generate_tts():
    print("=" * 60)
    print("生成 TTS 配音 - 一拳超人 vs 鸣人")
    print("=" * 60)
    
    # 计算字符数
    char_count = len(SCRIPT)
    print(f"\n📝 脚本字数：{char_count} 字符")
    print(f"⏱️ 预计时长：{char_count / 4:.1f} 秒（按 4 字/秒计算）")
    ...
    try:
        ...
        if response.status_code == 200:
            # 保存音频
            output_path = "/home/jcs130/.copaw/workspaces/64cKss/media/project_002/narration.mp3"
